...
function getStyles(t) {
  return {
    container: { minHeight: '100vh', background: t.mainBg, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", color: t.textPrimary, fontSize: 13 },
    loading: { minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: t.textMuted },
    notification: { position: 'fixed', top: 16, right: 16, padding: '10px 20px', borderRadius: 6, color: '#fff', fontWeight: 500, zIndex: 1000, fontSize: 13, boxShadow: '0 4px 12px rgba(0,0,0,0.4)' },
    header: { background: t.sidebarBg, borderBottom: `1px solid ${t.border}`, padding: '10px 24px' },
    headerContent: { maxWidth: 1800, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
    headerRight: { display: 'flex', alignItems: 'center', gap: 12 },
    title: { margin: 0, fontSize: 18, color: t.textPrimary, fontWeight: 700 },
    subtitle: { margin: '2px 0 0', fontSize: 11, color: t.textDim, fontWeight: 500 },
    nav: { display: 'flex', gap: 2 },
    navLink: { padding: '6px 14px', color: t.textMuted, textDecoration: 'none', borderRadius: 4, fontWeight: 500, fontSize: 12 },
    navLinkActive: { background: t.accent, color: '#fff' },
    themeToggle: { width: 32, height: 32, borderRadius: 6, border: `1px solid ${t.border}`, background: 'transparent', cursor: 'pointer', fontSize: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', color: t.textMuted },
    main: { display: 'flex', maxWidth: 1800, margin: '0 auto', minHeight: 'calc(100vh - 52px)' },
    sidebar: { width: 220, background: t.sidebarBg, borderRight: `1px solid ${t.border}`, padding: 12, flexShrink: 0, display: 'flex', flexDirection: 'column' },
    sidebarTabs: { display: 'flex', gap: 2, marginBottom: 10 },
    sidebarTabBtn: { flex: 1, padding: '6px 8px', background: 'transparent', color: t.textMuted, border: 'none', borderRadius: 4, cursor: 'pointer', fontWeight: 600, fontSize: 11 },
    sidebarTabActive: { background: t.panelBg, color: t.textPrimary },
    sidebarSearch: { width: '100%', padding: '7px 10px', background: t.inputBg, border: `1px solid ${t.border}`, borderRadius: 4, color: t.textPrimary, fontSize: 12, boxSizing: 'border-box', marginBottom: 8, outline: 'none' },
    tournamentList: { display: 'flex', flexDirection: 'column', gap: 2, flex: 1, overflow: 'auto' },
    emptyMsg: { color: t.textDim, fontSize: 11, textAlign: 'center', padding: '16px 0' },
    tournamentItem: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 10px', background: 'transparent', borderRadius: 4, cursor: 'pointer', borderLeft: '3px solid transparent' },
    tournamentActive: { background: t.panelBg, borderLeftColor: t.accent },
    tournamentInfo: { display: 'flex', flexDirection: 'column', gap: 2, overflow: 'hidden', flex: 1 },
    tournamentName: { fontWeight: 500, color: t.textSecondary, fontSize: 12, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
    tournamentNameActive: { color: t.textPrimary, fontWeight: 600 },
    tournamentStats: { fontSize: 10, color: t.textDim },
    delBtn: { width: 20, height: 20, background: 'transparent', color: t.textDim, border: 'none', borderRadius: 3, cursor: 'pointer', fontSize: 14, opacity: 0.5 },
    newTournamentBtn: { marginTop: 8, padding: 8, background: t.panelBg, color: t.textSecondary, border: `1px solid ${t.border}`, borderRadius: 4, cursor: 'pointer', fontWeight: 600, fontSize: 11 },
    content: { flex: 1, padding: '16px 20px', overflow: 'auto', background: t.mainBg },
    welcome: { textAlign: 'center', padding: '80px 40px' },
    welcomeTitle: { fontSize: 20, color: t.textSecondary, marginBottom: 8, fontWeight: 600 },
    welcomeText: { color: t.textDim, fontSize: 13 },
    tournamentHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
    tournamentMeta: { display: 'flex', alignItems: 'baseline', gap: 16 },
    tournamentTitleMain: { fontSize: 16, color: t.textSecondary, margin: 0, fontWeight: 600 },
    handednessContainer: { display: 'flex', gap: 12 },
    handednessGroup: { color: t.textDim, fontSize: 11, fontFamily: 'ui-monospace, monospace' },
    uploadBtn: { padding: '6px 12px', background: 'transparent', color: t.textMuted, border: `1px solid ${t.border}`, borderRadius: 4, cursor: 'pointer', fontWeight: 500, fontSize: 11 },
    tabRow: { marginBottom: 10 },
    tabs: { display: 'flex', gap: 2 },
    tab: { padding: '6px 14px', background: 'transparent', color: t.textMuted, border: 'none', borderRadius: 4, cursor: 'pointer', fontWeight: 500, fontSize: 12 },
    tabActive: { background: t.panelBg, color: t.textPrimary },
    tabCount: { marginLeft: 4, color: t.textDim, fontWeight: 400 },
    controlBar: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10, padding: '8px 12px', background: t.panelBg, borderRadius: 6 },
    controlGroup: { display: 'flex', alignItems: 'center', gap: 4 },
    controlDivider: { width: 1, height: 20, background: t.border, margin: '0 4px' },
    searchInput: { padding: '5px 10px', background: t.inputBg, color: t.textPrimary, border: `1px solid ${t.border}`, borderRadius: '4px 0 0 4px', fontSize: 12, width: 140, outline: 'none' },
    filterSelect: { padding: '5px 10px', background: t.inputBg, color: t.textPrimary, border: `1px solid ${t.border}`, borderLeft: 'none', borderRadius: '0 4px 4px 0', fontSize: 12, cursor: 'pointer', outline: 'none' },
    controlBtn: { padding: '5px 10px', background: 'transparent', color: t.textMuted, border: `1px solid ${t.border}`, borderRadius: 4, cursor: 'pointer', fontSize: 11, fontWeight: 500, display: 'flex', alignItems: 'center', gap: 4 },
